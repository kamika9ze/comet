        ...
        header: function(e) {
          ...
          i.desktopDevice && (setTimeout(function() {
            ...
            n.removeClass("opened"), i > 0 ? (e.css({
              ...
              position: "absolute"
            }), t.addClass("active")), n.attr("icon", "blue"), _.each(u, function(e) {
              console.log(i);
              console.log(e[0]);
              console.log(e[1]);
          ...
          var d = {
            ...
            l = function() {
              ...
              var i = e.attr("room"),
                n = e.attr("area"),
                o = e.attr("problem");
              if (i && (_.indexOf(d.rooms, i) >= 0 ? (d.rooms = _.without(d.rooms, i), e.removeClass("active"), r.find("li[room='" + i + "']").remove()) : (d.rooms.push(i), e.addClass("active"), r.append("<li room='" + i + "' ><p>Поверхность</p><p>" + e.text() + "</p></li>"))), n && (_.indexOf(d.areas, n) >= 0 ? (d.areas = _.without(d.areas, n), e.removeClass("active"), r.find("li[area='" + n + "']").remove()) : (d.areas.push(n), e.addClass("active"), r.append("<li area='" + n + "' ><p>Помещение</p><p>" + e.text() + "</p></li>"))), o && (_.indexOf(d.problems, o) >= 0 ? (d.problems = _.without(d.problems, o), e.removeClass("active"), r.find("li[problem='" + o + "']").remove()) : (d.problems.push(o), e.addClass("active"), r.append("<li problem='" + o + "' ><p>Проблема</p><p>" + e.text() + "</p></li>"))), !d.rooms.length && !d.areas.length && !d.problems.length) return void c.show();
